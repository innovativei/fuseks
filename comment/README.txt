...
The order in which these conditions are checked defaults to the following supported templates:
...
This order can be overridden with a plugin using the `cfct_comment_match_order` hook.
